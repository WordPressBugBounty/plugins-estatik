    ...
    public static function get_changelog() {
        return array(
            ...
            '4.3.2' => array(
                ...
                'changes' => array(
                    array(
                        'text' => _x( 'Security improvements and fixes (All versions)', 'changelog', 'es' ),
                        'label' => 'new',
                    ),
                    array(
                        'text' => _x( 'New styles added for SiteOrigin Estatik widgets (All versions)', 'changelog', 'es' ),
                        'label' => 'new',
                    ),
                    array(
                        'text' => _x( 'Estatik slider and slideshow Gutenberg blocks added (Pro & Premium)', 'changelog', 'es' ),
                        'label' => 'new',
                    ),
                    array(
                        'text' => _x( 'Agent details section added (Pro & Premium)', 'changelog', 'es' ),
                        'label' => 'new',
                    ),
                    array(
                        'text' => _x( 'Added an ability to import multiple agents for a single listing (Premium)', 'changelog', 'es' ),
                        'label' => 'new',
                    ),
            
                    array(
                        'text' => _x( 'Sorting by agent name fixed on agents admin page (Pro & Premium)', 'changelog', 'es' ),
                        'label' => 'bugfix',
                    ),
                    array(
                        'text' => _x( 'Email reminders for saved searches fixed (Pro & Premium)', 'changelog', 'es' ),
                        'label' => 'bugfix',
                    ),
                    array(
                        'text' => _x( 'Framework switcher default value fixed (All versions)', 'changelog', 'es' ),
                        'label' => 'bugfix',
                    ),
                    array(
                        'text' => _x( 'Lowest sq ft sorting fixed (All versions)', 'changelog', 'es' ),
                        'label' => 'bugfix',
                    ),
                    array(
                        'text' => _x( 'Media import fixed for query.ampre.ca (Premium)', 'changelog', 'es' ),
                        'label' => 'bugfix',
                    ),
                ),
            ),
